...
COPY users(userid,gender,age,job,zipcode) from '/home/jim/RecDB/PostgreSQL/moviedata/MovieLens1M/users.dat' DELIMITERS ';';
COPY items(itemid,name,genre) from '/home/jim/RecDB/PostgreSQL/moviedata/MovieLens1M/movies.dat' DELIMITERS ';';
COPY ratings(userid,itemid,ratingval,ratingts) from '/home/jim/RecDB/PostgreSQL/moviedata/MovieLens1M/ratings.dat' DELIMITERS ';';
