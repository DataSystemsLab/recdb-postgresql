...
/* Possible cell types for a RECOMMEND query. */
typedef enum {
	CELL_ALPHA,
	CELL_BETA,
	CELL_GAMMA
...
/* Possible operator types for a RECOMMEND query. */
typedef enum {
	OP_FILTER,
	OP_NOFILTER,
	OP_JOIN,
...
typedef struct RangeTblEntry
{
	 ...
	 * NEW FOR RECATHON
	 *
	 * Field necessary to indicate a table is used in a RECOMMEND query.
	 */
	Node		*recommender;	/* does this apply to a recommender? */
...
typedef struct SelectStmt
{
	...
	/*
	 * EDITED FOR RECATHON. We attach some information about a RECOMMEND clause here.
	 */
	Node	   *recommendClause;	/* the recommend limit and any extra qualifications */
...
/* ----------------------
 *		Recommend Operator Information
 * ----------------------
 */
