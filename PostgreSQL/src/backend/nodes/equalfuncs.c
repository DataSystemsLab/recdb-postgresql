...
_equalSelectStmt(const SelectStmt *a, const SelectStmt *b)
{
	...
	COMPARE_NODE_FIELD(recommendClause);
	COMPARE_SCALAR_FIELD(op);
...
static bool
_equalAttributeInfo(const AttributeInfo *a, const AttributeInfo *b)
{
	COMPARE_SCALAR_FIELD(userID);
...
equal(const void *a, const void *b)
{
	...
	switch (nodeTag(a))
	{
		...
		case T_RecommendInfo:
			retval = _equalRecommendInfo(a, b);
			break;
		case T_AttributeInfo:
			retval = _equalAttributeInfo(a, b);
			break;
