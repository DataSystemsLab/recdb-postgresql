				   ...
				   bool inFromCl)
{
	 ...
	 * NEW FOR RECATHON
	 *
	 * If we're supplied a RangeVar, there's a chance that this RTE will apply
	 * to a RECOMMEND query. Pass it on.
	 */
	rte->recommender = relation->recommender;
							  ...
							  bool inFromCl)
{
	 ...
	 * NEW FOR RECATHON
	 *
	 * This RTE won't apply to a recommender.
	 */
	rte->recommender = NULL;
